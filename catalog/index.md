...
| [Create WebServices Test Cases From User Story](../prompts/azure-devops/create-webservices-test-cases-from-user-story.md) | Generate test cases from webservices user story; reuse provided requirement-based suite or create one under a provided test plan | user story ID, requirement based suite ID optional, test plan ID conditional, webservice URL | Requirement Based Suite ID, TC###-prefixed test case IDs | Active | v1.19 |
