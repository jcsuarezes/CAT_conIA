# Default Profile (Non-sensitive)

## Identity
- Profile name: `default`
- Username alias: `suarez.juan@cat.com`
- Team:
...
- Work item assigned user default: `suarez.juan@cat.com`

## Secret References (aliases only)
- PAT alias: `AZDO_PAT_MAIN`
- Entra token alias: `AZDO_ENTRA_TOKEN`

> Do not place real tokens in this file.
