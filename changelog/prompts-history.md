...
## 2026-02-24 (v1.3)
- Added quickstart prompt `ready/generate-work-item-urls-alt-org.quickstart.md` for fast Work Item URL generation in alternate organization mode.
- Registered the quickstart in `catalog/index.md` (Quick Access and Quickstarts table).

## 2026-02-23 (v1.2)
- Added reusable prompt `generate-work-item-urls-alt-org.md` for generating Work Item web URLs from IDs using `https://dev.azure.com/cat-digital/` and project `cat-digital`.
- Registered prompt in `catalog/index.md` (Quick Access and Core Prompts).
